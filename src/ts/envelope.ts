function applyEnvelope() {
    ...
    if (synthesizerWorkbench.modules.envelope.timeTable.attack.type == "linear") {
        ...
        synthesizerWorkbench.modules.envelope.components.gain.component.gain.linearRampToValueAtTime
            (
                synthesizerWorkbench.modules.envelope.timeTable.attack.amplitude,
                synthesizerWorkbench.audioContext.currentTime
        ...
        synthesizerWorkbench.modules.envelope.components.gain.component.gain.setTargetAtTime
            (
                synthesizerWorkbench.modules.envelope.timeTable.attack.amplitude,
                synthesizerWorkbench.audioContext.currentTime,
                synthesizerWorkbench.modules.envelope.timeTable.attack.time
    ...
    if (synthesizerWorkbench.modules.envelope.timeTable.decay.type == "linear") {
        ...
        synthesizerWorkbench.modules.envelope.components.gain.component.gain.linearRampToValueAtTime
            (
                synthesizerWorkbench.modules.envelope.timeTable.decay.amplitude,
                synthesizerWorkbench.audioContext.currentTime
                + synthesizerWorkbench.modules.envelope.timeTable.attack.time
    ...
    if (synthesizerWorkbench.modules.envelope.timeTable.sustain.type == "linear") {
        ...
        synthesizerWorkbench.modules.envelope.components.gain.component.gain.linearRampToValueAtTime
            (
                synthesizerWorkbench.modules.envelope.timeTable.sustain.amplitude,
                synthesizerWorkbench.audioContext.currentTime
                + synthesizerWorkbench.modules.envelope.timeTable.attack.time
                + synthesizerWorkbench.modules.envelope.timeTable.decay.time
    ...
    if (synthesizerWorkbench.modules.envelope.timeTable.release.type == "linear") {
        ...
        synthesizerWorkbench.modules.envelope.components.gain.component.gain.linearRampToValueAtTime
            (
                synthesizerWorkbench.modules.envelope.timeTable.release.amplitude,
                synthesizerWorkbench.audioContext.currentTime
                + synthesizerWorkbench.modules.envelope.timeTable.attack.time
                + synthesizerWorkbench.modules.envelope.timeTable.decay.time
                + synthesizerWorkbench.modules.envelope.timeTable.sustain.time
