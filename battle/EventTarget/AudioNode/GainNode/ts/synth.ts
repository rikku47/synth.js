...
let osc1Type = document.getElementById("wave-form-osc1") as HTMLSelectElement;
...
let osc1Frequency = document.getElementById("frequency-osc1") as HTMLInputElement;
osc1Frequency?.addEventListener("input", () => {
    osc1.frequency.value = Number(osc1Frequency.value);
});

let osc1Detune = document.getElementById("detune-osc1") as HTMLInputElement;
osc1Detune?.addEventListener("input", () => {
    console.log(osc1Detune.value);
    osc1.detune.value = Number(osc1Detune.value);
});

let osc1GainSlider = document.getElementById("gain-osc1-slider") as HTMLInputElement;
...
let osc1GainInput = document.getElementById("gain-osc1-input") as HTMLInputElement;
...
let osc2Type = document.getElementById("wave-form-osc2") as HTMLSelectElement;
...
let osc2Frequency = document.getElementById("frequency-osc2") as HTMLInputElement;
osc2Frequency?.addEventListener("input", () => {
    osc2.frequency.value = Number(osc2Frequency.value);
});

let osc2Detune = document.getElementById("detune-osc2") as HTMLInputElement;
osc2Detune?.addEventListener("input", () => {
    console.log(osc2Detune.value);
    osc2.detune.value = Number(osc2Detune.value);
});

let osc2GainSlider = document.getElementById("gain-osc2-slider") as HTMLInputElement;
...
let osc2GainInput = document.getElementById("gain-osc2-input") as HTMLInputElement;
...
let osc3Type = document.getElementById("wave-form-osc3") as HTMLSelectElement;
...
let osc3Frequency = document.getElementById("frequency-osc3") as HTMLInputElement;
osc1Frequency?.addEventListener("input", () => {
    osc3.frequency.value = Number(osc3Frequency.value);
});

let osc3Detune = document.getElementById("detune-osc3") as HTMLInputElement;
osc3Detune?.addEventListener("input", () => {
    console.log(osc3Detune.value);
    osc3.detune.value = Number(osc3Detune.value);
});

let osc3GainSlider = document.getElementById("gain-osc3-slider") as HTMLInputElement;
...
let osc3GainInput = document.getElementById("gain-osc3-input") as HTMLInputElement;
...
let osc4Type = document.getElementById("wave-form-osc4") as HTMLSelectElement;
...
let osc4Frequency = document.getElementById("frequency-osc4") as HTMLInputElement;
osc1Frequency?.addEventListener("input", () => {
    osc4.frequency.value = Number(osc4Frequency.value);
});

let osc4Detune = document.getElementById("detune-osc4") as HTMLInputElement;
osc4Detune?.addEventListener("input", () => {
    console.log(osc4Detune.value);
    osc4.detune.value = Number(osc4Detune.value);
});

let osc4GainSlider = document.getElementById("gain-osc4-slider") as HTMLInputElement;
...
let osc4GainInput = document.getElementById("gain-osc4-input") as HTMLInputElement;
...
function playCD(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playD(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playDE(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playE(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playF(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playFG(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playG(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playGA(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playA(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playAB(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function playB(frequency: number) {
    osc1.frequency.value = frequency;
    osc2.frequency.value = frequency;
    osc3.frequency.value = frequency;
    osc4.frequency.value = frequency;
...
function play() {
    ...
    class MusicSheet {
        ...
        private _baseBeatNoteValue: number = 4;

        public get baseBeatNoteValue(): number {
            return this._baseBeatNoteValue;
        };

        public set baseBeatNoteValue(value: number) {
            this._baseBeatNoteValue = value;
        };

        totalWholeNotesPerMinute: number = 30;
        wholeNote: number = 2;
        halfNote: number = 1;
        quarterNote: number = 0.25;
        eighthNote: number = 0.125;
        sixteenthNote: number = 0.0625;
